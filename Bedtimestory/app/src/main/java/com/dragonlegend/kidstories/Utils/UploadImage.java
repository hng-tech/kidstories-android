...
public class UploadImage {
    ...
    public static void uploadFile(String fileUri, String storyTitle, String storyBody,
...
//                        okhttp3.MultipartBody.FORM, category);
        ...
        MainAplication.getApiInterface().addStory(title,body,category_id,photo,age,author,is_premium).
